...
public final class UwIntegerJsonDeserializer implements JsonDeserializer<Integer> {

	/**
	 * Initialize an {@link UwIntegerJsonDeserializer} instance.
	 */
	public UwIntegerJsonDeserializer() {
	}
